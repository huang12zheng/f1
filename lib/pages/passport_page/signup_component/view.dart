                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            top: 20.0, bottom: 20.0, left: 25.0, right: 25.0),
                        child: TextField(
                          focusNode: state.focusNodeMoblie,
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: GestureDetector(
                              onTap: ()=>dispatch(SignupActionCreator.toggleSignup()),
                              child: Icon(
                                state.signupFlag
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            top: 20.0, bottom: 20.0, left: 25.0, right: 25.0),
                        child: TextField(
                          focusNode: state.focusNodeConfirmPassword,
                          controller: state.confirmPasswordController,
                          obscureText: state.confirmFlag,
                          style: TextStyle(
                              fontFamily: "WorkSansSemiBold",
                              fontSize: 16.0,
                              color: Colors.black),
                          decoration: InputDecoration(
                            ...
                            hintStyle: TextStyle(
                                fontFamily: "WorkSansSemiBold", fontSize: 16.0),
                            suffixIcon: GestureDetector(
                              onTap: ()=>dispatch(SignupActionCreator.toggleConfirm()),
                              child: Icon(
                                state.confirmFlag
                                    ? FontAwesomeIcons.eye
                                    : FontAwesomeIcons.eyeSlash,
